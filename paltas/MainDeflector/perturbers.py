...
class MainDeflectorWithPerturber(MainDeflectorBase):
        ...
        required_parameters = ('gamma','theta_E','e1','e2','center_x','center_y','gamma1','gamma2',
                                'ra_0','dec_0','z_lens','p_theta_E','p_center_x','p_center_y')
        ...
        def draw_main_deflector(self):
                ...
                for model in md_model_list:
                        ...
                        if model == 'SIS':
                                model_kwargs = {'theta_E':self.main_deflector_parameters['p_theta_E'],
                                                'center_x':self.main_deflector_parameters['p_center_x'],
                                                'center_y':self.main_deflector_parameters['p_center_y']}
